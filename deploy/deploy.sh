...
kubectl delete deployment admin-authentication --namespace=dev --ignore-not-found=true
kubectl delete service admin-authentication --namespace=dev --ignore-not-found=true
